...
const recipes: Recipe[] = [
  {
    ...
    difficulty: 'Easy',
    ingredients: {
      en: ['1kg Seasoned Shawarma from Ahd Trade', 'Basmati Rice', 'Mixed Vegetables', 'Garlic Sauce'],
      ar: ['1 كيلو شاورما متبلة من عهد للتجارة', 'أرز بسمتي', 'خضار مشكلة', 'صلصة الثوم']
    }
  },
  {
    id: '2',
    ...
    difficulty: 'Medium',
    ingredients: {
      en: ['1 Whole Chicken (1.2kg) from Ahd Trade', 'Fresh Herbs', 'Olive Oil', 'Root Vegetables'],
      ar: ['دجاج كامل (1.2 كيلو) من عهد للتجارة', 'أعشاب طازجة', 'زيت زيتون', 'خضار جذرية']
    }
  },
  {
    id: '3',
    ...
    difficulty: 'Easy',
    ingredients: {
      en: ['1kg Chicken Wings from Ahd Trade', 'Hot Sauce', 'Honey', 'Butter', 'Garlic'],
      ar: ['1 كيلو أجنحة دجاج من عهد للتجارة', 'صلصة حارة', 'عسل', 'زبدة', 'ثوم']
    }
  },
  {
    id: '4',
    ...
    image: '/images/liver-pan.jpg',
    prepTime: '30 min',
    servings: '8-10',
    difficulty: 'Medium',
    ingredients: {
      en: ['500g Chicken Liver from Ahd Trade', 'Butter', 'Onions', 'Brandy', 'Cream'],
      ar: ['500 جرام كبد دجاج من عهد للتجارة', 'زبدة', 'بصل', 'براندي', 'كريمة']
    }
  },
  {
    id: '5',
    ...
    difficulty: 'Easy',
    ingredients: {
      en: ['500g Ground Chicken from Ahd Trade', 'Burger Buns', 'Lettuce', 'Tomato', 'Special Sauce'],
      ar: ['500 جرام دجاج مفروم من عهد للتجارة', 'خبز برغر', 'خس', 'طماطم', 'صلصة خاصة']
    }
  }
];
...
const RecipeCarousel = () => {
  ...
  const handleGetRecipe = (recipeName: string) => {
    const message = isRTL 
      ? `مرحباً! أريد الحصول على الوصفة الكاملة لـ ${recipeName} مع قائمة المكونات والتعليمات من عهد للتجارة.`
      : `Hello! I would like to get the complete recipe for ${recipeName} with ingredients list and instructions from Ahd Trade.`;
