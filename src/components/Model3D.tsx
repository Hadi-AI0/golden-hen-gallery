        ...
        <div className={`flex flex-col lg:flex-row items-center gap-12 ${isRTL ? 'lg:flex-row-reverse' : ''}`}>
          ...
          <div className="flex-1 flex justify-center">
            <div className="relative max-w-lg w-full">
              <img 
                src="/images/whole-chicken.png"
                alt={isRTL ? 'دجاج كامل كل الاوزان - منتج عهد للتجارة المميز' : 'Raw Chicken in Commercial Package - Ahd Trade Signature Product'}
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3 ${isRTL ? 'flex-row-reverse text-right' : ''}">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    {isRTL 
                      ? 'فحوصات جودة شاملة لتناسب المطاعم والمتاجر'
