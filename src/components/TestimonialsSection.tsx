  ...
  const testimonials = [
    {
      ...
      text: isRTL 
        ? 'نتعامل مع عهد للتجارة منذ ثلاث سنوات، والجودة ثابتة دائماً. عملاؤنا يلاحظون الفرق في طعم الدجاج المشوي. التوصيل دقيق والأسعار تنافسية للمطاعم.'
        : 'We\'ve been working with Ahd Trade for three years now. The quality is consistently excellent. Our customers notice the difference in our grilled chicken dishes. Delivery is reliable and the wholesale pricing works perfectly for our restaurant margins.',
      rating: 5
    },
    {
      ...
      text: isRTL
        ? 'نخدم أكثر من 200 حفل شهرياً، وعهد للتجارة يلبي احتياجاتنا دائماً. الشاورما المتبلة توفر علينا ساعات في المطبخ. خدمة عملاء ممتازة ومرونة في الطلبات الكبيرة.'
        : 'We cater over 200 events monthly, and Ahd Trade never lets us down. Their seasoned shawarma saves us hours in the kitchen. Excellent customer service and flexible ordering for large quantities. They understand the catering business.',
      rating: 5
    },
    {
      ...
      text: isRTL
        ? 'لدينا 8 فروع في الرياض، وعهد للتجارة يغطي كل فروعنا بنفس مستوى الجودة. الدجاج المفروم عالي الجودة لبرغر الدجاج لدينا. شريك موثوق في نجاح أعمالنا.'
        : 'We operate 8 branches in Riyadh, and Ahd Trade supplies all our locations with consistent quality. Their ground chicken is perfect for our signature chicken burgers. They\'re a trusted partner in our business success.',
      rating: 5
    },
    {
      ...
      text: isRTL
        ? 'زبائن المتجر يثقون في منتجات عهد للتجارة. الدجاج الكامل بأحجام مختلفة يلبي طلبات كل العائلات. هامش الربح جيد والمنتجات تبقى طازجة لفترة أطول.'
        : 'Our retail customers trust Ahd Trade products. The whole chickens in different sizes meet every family\'s needs. Good profit margins and the products stay fresh longer, which reduces our waste significantly.',
      rating: 5
    }
  ];
